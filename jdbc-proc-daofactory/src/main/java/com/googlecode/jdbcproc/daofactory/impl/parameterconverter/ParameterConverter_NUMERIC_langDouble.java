 ...
 * DECIMAL - boolean
 */
public class ParameterConverter_NUMERIC_langDouble
        implements IParameterConverter<ParameterConverter_NUMERIC_langDouble, Double> {

    public static final Type<ParameterConverter_NUMERIC_langDouble> TYPE
            = new Type<ParameterConverter_NUMERIC_langDouble>(Types.NUMERIC, Double.class);
    ...
    public Type<ParameterConverter_NUMERIC_langDouble> getType() {
        return TYPE;
    }
