 ...
 *  REAL - double
 */
public class ParameterConverter_DOUBLE_langDouble
    implements IParameterConverter<ParameterConverter_DOUBLE_langDouble, Double> {

  public static final Type<ParameterConverter_DOUBLE_langDouble> TYPE
      = new Type<ParameterConverter_DOUBLE_langDouble>(Types.DOUBLE, Double.class);
  ...
  public Type<ParameterConverter_DOUBLE_langDouble> getType() {
    return TYPE;
  }

    public String toString() {
        return "ParameterConverter_DOUBLE_langDouble{}";
    }
}
